...
setattr(_ac_t, "_is_xformers_available", lambda: True)
# ---------------------------------------------------------------------------
...
with gr.Blocks(title=APP_NAME, theme=gr.themes.Soft(), fill_height=True) as demo:
    ...
    gr.Markdown(
        ...
        "If you ever see a schema/bool error, ensure **Gradio ≥ 4.44.1**. "
